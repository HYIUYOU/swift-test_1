...
let a = calculatePace(currentDistance: 2.0, totalDistance: 20.0, currentTime: 10.0);
print(a);
/*:
...
let b = pacing(currentDistance: 10, totalDistance: 20, currentTime: 10, goalTime: 10)
print(b)
/*:
